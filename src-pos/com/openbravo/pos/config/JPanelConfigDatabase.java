...
//                "Apache Derby Client/Server".equals(jcboDBDriver.getSelectedItem()) ||
//                "Apache Derby Client/Server".equals(jcboDBDriver.getSelectedItem()) ||
//                "HSQLDB".equals(jcboDBDriver.getSelectedItem()) ||
//                "MySQL".equals(jcboDBDriver.getSelectedItem()) ||
//                "Oracle 11g Express".equals(jcboDBDriver.getSelectedItem()) ||
//                "PostgreSQL".equals(jcboDBDriver.getSelectedItem()))
//        {
//            jLabel18.setText(AppLocal.getIntString("label.dbdriverlib"));
//            jLabel1.setText(AppLocal.getIntString("Label.DbDriver"));
//            jLabel2.setText(AppLocal.getIntString("Label.DbURL"));
//            jbtnDbDriverLib.setVisible(true);
//        }
...
//            jLabel1.setText(AppLocal.getIntString("Label.DbPort"));
//            jLabel2.setText(AppLocal.getIntString("Label.Database"));
