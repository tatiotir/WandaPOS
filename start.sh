...
# start Openbravo POS
java -cp $CP -Dswing.defaultlaf=javax.swing.plaf.metal.MetalLookAndFeel -Djava.library.path=$DIRNAME$LIBRARYPATH -Ddirname.path=$DIRNAME/ -splash:wandapos-splash.png com.openbravo.pos.forms.StartPOS "$@"
